...
<!-- section featured -->
    <section id="featured">
      ...
      <div class="camera_wrap" id="camera-slide">
          ...
          <div class="camera_caption fadeFromLeft">
            <div class="container">
              <div class="row">
                ...
                <div class="span6">
                  <img src="resources/img/slides/camera/slide1/screen.png" alt="" class="animated bounceInDown delay1" />
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- slide 2 here -->
        <div data-src="resources/img/slides/camera/slide2/img1.jpg">
          <div class="camera_caption fadeFromLeft">
            <div class="container">
              <div class="row">
                <div class="span6">
                  <img src="resources/img/slides/camera/slide2/iMac.png" alt="" />
                </div>
                <div class="span6">
            ...
            <div class="container">
              <div class="row">
                <div class="span12 aligncenter">
                  ...
                  <img src="resources/img/slides/camera/slide3/browsers.png" alt="" class="animated bounceInDown delay1" />
                </div>
              </div>
            </div>
          </div>
            ...
            <ul class="bxslider">
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="resources/img/dummies/testimonial/1.png" alt="" />
                  <h4>Hillary Doe</h4>
              ...
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="resources/img/dummies/testimonial/2.png" alt="" />
                  <h4>Michael Doe</h4>
                  <a href="#">www.companyname.com</a>
                </div>
              </li>
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="resources/img/dummies/testimonial/3.png" alt="" />
                  <h4>Mark Donovan</h4>
                  <a href="#">www.companyname.com</a>
                </div>
              </li>
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="resources/img/dummies/testimonial/4.png" alt="" />
            ...
            <div class="row">
              ...
              <div class="grid cs-style-4">
                <div class="span3">
                  <div class="item">
                    <figure>
                      <div><img src="resources/img/dummies/works/1.jpg" alt="" /></div>
                      <figcaption>
                        <div>
                          <span>
								<a href="resources/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
								</span>
                          <span>
                ...
                <div class="span3">
                  <div class="item">
                    <figure>
                      <div><img src="resources/img/dummies/works/2.jpg" alt="" /></div>
                      <figcaption>
                        <div>
                          <span>
								<a href="resources/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
                ...
                <div class="span3">
                  <div class="item">
                    <figure>
                      <div><img src="resources/img/dummies/works/3.jpg" alt="" /></div>
                      <figcaption>
                        <div>
                          <span>
								<a href="resources/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
                ...
                <div class="span3">
                  <div class="item">
                    <figure>
                      <div><img src="resources/img/dummies/works/4.jpg" alt="" /></div>
                      <figcaption>
                        <div>
                          <span>
								<a href="resources/img/dummies/works/big.png" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-plus icon-circled icon-bglight icon-2x"></i></a>
